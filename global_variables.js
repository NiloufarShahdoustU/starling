...
export const deck_number1_uni_selected = Array(deck_number1_uni.length).fill(0);
export const deck_number2_uni_selected = Array(deck_number1_uni.length).fill(0);
